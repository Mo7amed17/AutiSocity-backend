...
# بناء سلسلة الاتصال
connection_string = 'DRIVER={ODBC Driver 13 for SQL Server};SERVER=' + server + ';DATABASE=' + database + ';UID=' + username + ';PWD=' + password
...
class LinkDatabase:
    ...
    def __init__(self):
        try:
            ...
            print("Data Base Erroreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", e)